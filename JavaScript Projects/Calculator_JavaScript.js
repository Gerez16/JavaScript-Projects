...
const Calculator = {
    ...
    Display_Value: '0',
    //this will hold the first operand for any XPathExpression, we set it to null now
    First_Operand: null,
...
//this seection handles decimal points.
...
if (First_Operand == null) {
    ...
    //if operator exist, property look up is performed for the operator
    //in the Perform_Calculation object and the function that matches the
    //operator is executed.
    let result = Perform_Calculation[ operator](Value_Now, Value_of_Input);
    //here we add a fixed amount of the numbers after the decimal
...
//this function updates the calculator screen with the contest of Display_Value
function Update_Display() {
    //make use of the calculator-screen classs to target the
...
keys.addEventListener('click', (event) => {
    ...
    //ensures that AC clears all the input from the calculator screen.
